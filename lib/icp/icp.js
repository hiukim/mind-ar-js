...
const buildTransforms = ({screenCoords, worldCoords, debugContent}) => {
  ...
  */
  ...
  const {modelViewTransform, err} = icpPoint({initialModelViewTransform, projectionTransform: KData, worldCoords, screenCoords, debugContent});
...
icpPoint = ({initialModelViewTransform, projectionTransform, worldCoords, screenCoords, isRobustMode, inlierProb, debugContent}) => {
